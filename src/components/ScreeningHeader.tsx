      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-3 sm:px-6 lg:px-8 gap-2 sm:gap-4">
        ...
        <div className="flex items-center gap-3 xl:gap-5 shrink-0 min-w-0">
          <button
            ...
            className="group flex items-center gap-2.5 text-left outline-none shrink-0"
          >
          ...
          <nav className="hidden md:flex items-center p-1 rounded-xl bg-white/[0.04] border border-white/[0.08] shrink-0">
            <button
              type="button"
              onClick={() => onTabChange('storyboards')}
              className={`px-3 py-1.5 text-[12px] sm:text-[13px] font-medium rounded-lg transition-all flex items-center gap-1.5 whitespace-nowrap shrink-0 ${
        ...
        <div className="flex items-center gap-2 sm:gap-2.5 shrink-0">
          ...
          <button
            type="button"
            onClick={onOpenTray}
            className={`relative size-9 rounded-lg flex items-center justify-center border transition-all shrink-0 ${
              savedCount > 0
          ...
          <button
            ...
            className="flex items-center gap-1.5 sm:gap-2 px-2.5 py-1.5 rounded-lg bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.08] text-zinc-300 hover:text-white transition-all text-[12px] whitespace-nowrap shrink-0"
          >
